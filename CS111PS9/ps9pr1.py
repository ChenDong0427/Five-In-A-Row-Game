...
class Board:
    ...
    def add_checker(self, checker, col):
        ...
        x = self.height-1
        while self.slots[x][col] in 'X' or self.slots[x][col] in 'O':
            x -= 1
    ...
    def is_win_for(self, checker):
        ...
        """
        assert(checker == 'X' or checker == 'O')
        if self.is_horizontal_win(checker) == True or self.is_verticle_win(checker) == True or\
            self.is_down_diagonal_win(checker) == True or self.is_up_diagonal_win(checker) ==True:
                return True
        else:
            return False
    ...
    def is_verticle_win(self,checker):
         assert(checker == 'X' or checker == 'O')
